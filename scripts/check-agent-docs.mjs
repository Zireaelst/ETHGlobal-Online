...
const required = new Map([
  ["README.md", ["pnpm agent:e2e", "pnpm agent:serve", "pnpm agent:mcp", "pnpm agent:cli -- market list", "docs/marketplace.md"]],
  ["docs/agent-interfaces.md", ["createLocalClient", "npx blockterms", "submit_request", "POST /v1/orders", "search_data_products", "POST /v1/marketplace/bundles"]],
